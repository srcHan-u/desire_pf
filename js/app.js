(() => {
            ...
            !function(a) {
                ...
                return function() {
                    function a(b, c, d) {
                        ...
                        for (var f = void 0, g = 0; g < d.length; g++) e(d[g]);
                        return e;
                    }
                    return a;
                }()({
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery-contact__slider")) new core(".gallery-contact__slider", {
        ...
        da.init();
        var progressbar_min = __webpack_require__(26);
        if (document.getElementById("bar-1")) {
            const bar_1 = new progressbar_min.Line("#bar-1", {
                strokeWidth: 4,
                easing: "easeInOut",
                duration: 1400,
                color: "#363838",
                ...
                step: (state, bar) => {
                    bar.setText(Math.round(80 * bar.value()) + " %");
                }
            });
            const bar_2 = new progressbar_min.Line("#bar-2", {
                strokeWidth: 4,
                easing: "easeInOut",
                duration: 1400,
                color: "#363838",
                ...
                step: (state, bar) => {
                    bar.setText(Math.round(70 * bar.value()) + " %");
                }
            });
            const bar_3 = new progressbar_min.Line("#bar-3", {
                strokeWidth: 4,
                easing: "easeInOut",
                duration: 1400,
                color: "#363838",
                ...
                step: (state, bar) => {
                    bar.setText(Math.round(75 * bar.value()) + " %");
                }
            });
            const bar_4 = new progressbar_min.Line("#bar-4", {
                strokeWidth: 4,
                easing: "easeInOut",
                duration: 1400,
                color: "#363838",
                ...
                step: (state, bar) => {
                    bar.setText(Math.round(40 * bar.value()) + " %");
                }
            });
            bar_1.animate(1);
            bar_2.animate(1);
        ...
        if (document.querySelector(".video-about__video")) {
            const videoAbout = document.querySelector(".video-about__video");
            console.log(videoAbout);
            const buttonPlay = document.querySelector(".video-about__play");
